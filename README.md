...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yandexcloud-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12010&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yandexcloud-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yandexcloud` can be installed with:

```
conda install yandexcloud
```

It is possible to list all of the versions of `yandexcloud` available on your platform with:
